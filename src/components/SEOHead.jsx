...
const DEFAULT_METAS = {
  title: 'LivingKu — Studio Desain, Kontraktor RAB & Legalitas PMDN/PMA',
  description: 'LivingKu menyatukan jasa arsitektur interior & eksterior, kontraktor umum berlisensi LPJK dengan RAB transparan, pengurusan izin PT PMDN & PMA via OSS-RBA, serta kepatuhan akuntansi dan pajak korporasi di Indonesia.',
...
const ROUTE_SEO = {
  '/': {
    title: 'LivingKu — Studio Desain, Kontraktor RAB & Legalitas PMDN/PMA Indonesia',
  ...
  '/layanan': {
    title: 'Layanan Terpadu — Arsitektur, Kontraktor RAB, Legalitas PMA & Pajak | LivingKu',
    description: 'Eksplorasi 4 pilar layanan LivingKu: Desain Arsitektur DED & Render 4K, Jasa Konstruksi dengan Bill of Quantity (BQ) rinci, Pendirian PT PMA/PMDN & PBG, serta Akuntansi & Pajak PPN 12%.',
  ...
  '/simulasi-rab': {
    title: 'Kalkulator Simulasi RAB Konstruksi & Legalitas 2026 | LivingKu',
  ...
  '/portofolio': {
    title: 'Portofolio Proyek — Galeri Realisasi Villa & Komersial | LivingKu',
    description: 'Dokumentasi portofolio nyata LivingKu: rancang bangun villa mewah di Bali, fit-out interior kantor SCBD Jakarta, cafe & restoran komersial dengan kendali mutu bersertifikat dan izin resmi terbit.',
  ...
  '/blog': {
    title: 'Berita & Wawasan Industri — Konstruksi, Legalitas OSS & Pajak Properti | LivingKu',
  ...
  '/tentang-kami': {
    title: 'Tentang Kami — Firma Terpadu Arsitektur, Konstruksi & Legalitas | LivingKu',
    description: 'Mengenal profil LivingKu: tim arsitek berlisensi IAI, kontraktor berakreditasi LPJK/GAPENSI, notaris hukum bisnis PMA, dan konsultan pajak bersertifikat BKP dengan dedikasi transparansi dan mutu prima.',
  ...
  '/kontak': {
    title: 'Hubungi Kami — Konsultasi Arsitektur, RAB & Legalitas Denpasar | LivingKu',
    description: 'Hubungi tim profesional LivingKu untuk konsultasi gratis, permintaan penawaran RAB, atau jadwal survei lokasi. Kantor pusat: Jalan Kusuma Bangsa VII No. 71 Denpasar, Bali. WhatsApp: +62 897-0065-402.',
  ...
  '/cms': {
    title: 'CMS Portal — LivingKu Content Management System',
    description: 'Portal manajemen konten, galeri foto, berita, dan copywriting resmi LivingKu.',
